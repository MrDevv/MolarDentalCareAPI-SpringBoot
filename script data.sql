...
-- pacientes
INSERT INTO pacientes(apellido, nombre, dni, email, direccion, telefono, fechaDeNacimiento) 
...
-- Odontologos
INSERT INTO odontologos(apellido, nombre, dni, email, direccion, telefono, fechaDeNacimiento, estado) 
...
INSERT INTO horarios(id_odontologo, id_usuario,fecha, horaInicio, horaFin, estado) 
...
-- Pagos
INSERT INTO pagos(id_cita, id_formaPago, montoTotal, estado)
VALUES(1, 1, 30.0, 0);
INSERT INTO pagos(id_cita, id_formaPago, fechaPago ,montoTotal, estado)
